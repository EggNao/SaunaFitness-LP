      ...
      <div className={'py-10'}>
        ...
        <FadeIn>
          <div className={'m-auto my-8 w-10/12 text-center text-base'}>
            サウナ→水風呂→外気浴という1サイクルにより，ととのいを感じることができます．100度近くの高温から20度の水風呂に入ることで私たちは非日常的な生命の危機を感じ，自律神経，血圧，心拍に変化が生じます．この2つのプロセスでは自律神経（ストレス・緊張）が優位になり．さらにこの温度差により幸福感やストレス緩和のための脳内物質が分泌します．そして外気浴をすることで，副交感神経が有意に働き，リラックスした状態になり．さらに脳内物質が残った状態なのでよりリラックスできます．
          </div>
        </FadeIn>
        <FadeIn>
